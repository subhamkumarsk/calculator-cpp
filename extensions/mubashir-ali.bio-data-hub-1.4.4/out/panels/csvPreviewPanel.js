...
exports.CSVPreviewPanel = void 0;
const vscode = require("vscode");
const path = require("path");
const csvDataProvider_1 = require("../providers/csvDataProvider");
const fsModule = require("fs"); // Changed from require to import
class CSVPreviewPanel {
    constructor(panel, extensionUri, csvUri) {
        this._disposables = [];
        this._panel = panel;
    ...
    static createOrShow(extensionUri, csvUri) {
        ...
        const panel = vscode.window.createWebviewPanel("csvPreview", `Preview: ${csvUri.path.split("/").pop()}`, column || vscode.ViewColumn.One, {
    ...
    async _sortData(column, ascending) {
        try {
            const data = await this._csvDataProvider.parseCSVFile(this._csvUri);
...
exports.CSVPreviewPanel = CSVPreviewPanel;
//# sourceMappingURL=csvPreviewPanel.js.map