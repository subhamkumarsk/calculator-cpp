...
exports.showOnlineDatasetSearchInterface = exports.searchOnlineDatasets = void 0;
const vscode = require("vscode");
/**
 * Search for datasets on online repositories (Kaggle, Zenodo)
 */
async function searchOnlineDatasets(query) {
...
exports.searchOnlineDatasets = searchOnlineDatasets;
/**
 * Search for datasets on Kaggle
 * Note: This is a simplified implementation. In a real extension, you would use Kaggle API
 */
async function searchKaggleDatasets(query, token) {
 ...
 */
async function searchZenodoDatasets(query, token) {
    // Simulate API call with delay
 ...
 */
async function showOnlineDatasetSearchInterface() {
...
exports.showOnlineDatasetSearchInterface = showOnlineDatasetSearchInterface;
/**
...
//# sourceMappingURL=searchDatasets.js.map