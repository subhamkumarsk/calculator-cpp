 ...
 */
export async function generateMetadata(uri: vscode.Uri): Promise<CSVMetadata> {
 ...
 */
function determineDataType(numericValues: number[], uniqueValues: Set<string>): string {
