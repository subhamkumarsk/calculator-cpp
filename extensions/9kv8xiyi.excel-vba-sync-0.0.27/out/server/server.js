...
server.tool("ping", {}, () => __awaiter(void 0, void 0, void 0, function* () { return ({ content: [{ type: "text", text: "pong" }] }); }));
...
`.trim();
    try {
        const { stdout } = yield execFileAsync("powershell.exe", ["-NoLogo", "-NoProfile", "-NonInteractive", "-STA", "-ExecutionPolicy", "Bypass", "-Command", psScript], {
            windowsHide: true,
            encoding: "buffer",
            timeout: 20000,
        ...
        return { content: [{ type: "text", text: JSON.stringify({ ok: false, error: "ps_failed", detail: String((_a = e === null || e === void 0 ? void 0 : e.message) !== null && _a !== void 0 ? _a : e) }) }] };
    }
}));
// ������������������������������������������������������������ excel_list_macros ������������������������������������������������������������
server.tool("excel_list_macros", {
    ...
    try {
        const { stdout } = yield execFileAsync("powershell.exe", args, {
            windowsHide: true,
        ...
        return { content: [{ type: "text", text: JSON.stringify({ error: "ps failed", detail: String((_a = e === null || e === void 0 ? void 0 : e.message) !== null && _a !== void 0 ? _a : e) }) }] };
    }
}));
// ������������������������������������������������������������ excel_run_macros ������������������������������������������������������������
...
`;
    try {
        const { stdout } = yield execFileAsync("powershell.exe", ["-NoLogo", "-NoProfile", "-NonInteractive", "-STA", "-ExecutionPolicy", "Bypass", "-Command", psScript], { windowsHide: true, encoding: "buffer", timeout: 20000, maxBuffer: 2 * 1024 * 1024 });
        const outText = Buffer.isBuffer(stdout) ? stdout.toString("utf8") : String(stdout);
        //return { content: [{ type: "text", text: stdout }] };
        return { content: [{ type: "text", text: outText }] };
    }
